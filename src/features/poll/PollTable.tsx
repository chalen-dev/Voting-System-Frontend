                            ...
                            >
                                <td className="px-6 py-6">
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setSelectedIds(
                                                e.target.checked ? filteredPolls.map((p) => p.id) : []
                                            )
                                        }
                                        checked={
                                            filteredPolls.length > 0 &&
                                            selectedIds.length === filteredPolls.length
                                        }
                                    />
                                </td>
                        ...
                        <tbody className="divide-y divide-[var(--border-color)]">
                            {filteredPolls.length === 0 ? (
                                <tr>
                                    <td
                                        colSpan={5}
                                        className="px-6 py-10 text-center opacity-50 text-sm"
                                    >
